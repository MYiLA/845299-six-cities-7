...
const sortByPriceHighToLow = (hotel1: Hotel, hotel2: Hotel): number => hotel1.price - hotel2.price;
const sortByPriceLowToHigh = (hotel1: Hotel, hotel2: Hotel): number => hotel2.price - hotel1.price;
